...
class SearchBaseClass(ABC):
    ...
    def __init__(self, scenario: Scenario, planningProblem: PlanningProblem, automaton: ManeuverAutomaton,
        ...
        ###### Added by Mohamed A. Abdellaoui  24.12.2021 #########
        self.routeplannerresult = None
        self.planningProblemType= None
        self.newFarthersetPointSet = False
        self.reachedGoalModeB = False
        self.refPathParsedPnts =None
        self.thetaofpoints = None
        self.velocityLimit = None
        self.speedlimitsarry = None
        self.disableSpeedLimit = True
        self.disableRefPath = False
        self.disableObstAvoidance = False
        ###########################################################
